<template>
    <div class="background">
      <div class="container">
        ...
        <div v-else>
          <div v-if="currentQuestion !== null && !hiddenQuestions.includes(currentQuestion)" class="quiz-question">
  ...
  },
  {
    ...
    methods: {
        ...
        axiosCallEvaluation(){
            ...
            .get('/api/Activity')
            .then(response => {
                this.incorrectAnswer = response.data.data_incorrect_answer
               this.hiddenQuestions = this.incorrectAnswer.map(id => id - 1);
